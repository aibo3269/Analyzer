...
public:
  ...
  void writeout();
  int nentries;
  void checkParticleDecayList();
  void writeParticleDecayList(int);
  void fill_histogram();
...
private:
  ...
  double diParticleMassAlt(const TLorentzVector&, const TLorentzVector&, const TLorentzVector&, const TLorentzVector&, const TLorentzVector&t, string);
